...
for i in range(100):
    ...
    freq=np.random.normal(9.3, 1)
    bw=np.random.normal(1.6, 0.5)
    height=np.random.normal(0.5, 0.3)
    expon= np.random.normal(0.93, 0.21)
    ...
    for j in range(10):
        ...
        np.savetxt('./simulations/small/subject_' + str(i) + '_simulation_60sec_' + str(j) +'.csv', signal, delimiter=",")
...
parameters_used.to_csv('./simulations/small_effect_size_parameters_group1.csv')
...
for i in range(100, 200):
    ...
    freq=np.random.normal(9.3, 1)
    bw=np.random.normal(1.6, 0.5)
    height=np.random.normal(0.56, 0.3)
    expon= np.random.normal(0.93, 0.21)
    # Simulate aperiodic element
    print(i)
    for j in range(10):
...
parameters_used.to_csv('./simulations/small_effect_size_parameters_group2.csv')
