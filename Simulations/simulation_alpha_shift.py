...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 22 14:57:22 2022
...
for i in range(250):
    ...
    for j in range(100):
        ...
        np.savetxt('/Users/admin/Downloads/SimulatedData/frequency_new_new_new/0.8_250/subject_' + str(i) + '_simulation_6sec_' + str(j) +'.csv', signal, delimiter=",")
...
for i in range(250,500):
    ...
    n_seconds = 6 # length of recording 
    times = create_times(n_seconds, fs)
    freq=np.random.normal(8.724, 1.37)
    while freq<=0:
        freq=np.random.normal(8.724, 1.37)
    bw=np.random.normal(2.68, 1.64) 
    while bw <= 0:
...
parameters_used.to_csv('/Users/admin/Downloads/SimulatedData/frequency_new_new_new/0.8_250/effect_size_parameters.csv')

# Conduct a two-sided t-test
parameters_used = pd.read_csv('/Users/admin/Downloads/SimulatedData/frequency_new_new_new/0.8_250/effect_size_parameters.csv')
...
print(peak_freq_ttest, peak_band_ttest,peak_height_ttest, aper_expon_ttest)
