...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 30 23:35:22 2022
...
for i in range(250):
    ...
    freq=np.random.normal(19.33, 2.86)
    bw=np.random.normal(4.98, 1.07) 
    while bw <= 0:
        bw=np.random.normal(4.98, 1.07)   
    height=np.random.normal(0.48, 0.16)
    ...
    for j in range(100):
        ...
        np.savetxt('/Users/admin/Downloads/SimulatedData/beta_new/0.5_250_new_new/subject_' + str(i) + '_simulation_6sec_' + str(j) +'.csv', signal, delimiter=",")
...
for i in range(250,500):
    ...
    while bw <= 0:
        bw=np.random.normal(4.98, 1.07)   
    height=np.random.normal(0.39, 0.16)
    while height <= 0:                                                          # avoid getting negative values of peak height
        height=np.random.normal(0.39, 0.16)  
    expon= np.random.normal(-0.91, 0.15)
    # Simulate aperiodic element
...
parameters_used.to_csv('/Users/admin/Downloads/SimulatedData/beta_new/0.5_250_new_new/effect_size_parameters.csv')

# Conduct a two-sided t-test
parameters_used = pd.read_csv('/Users/admin/Downloads/SimulatedData/beta_new/0.5_250_new_new/effect_size_parameters.csv')
