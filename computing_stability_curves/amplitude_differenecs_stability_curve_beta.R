...
iterate_over_subject <- function(k, n) {  #iterations for a certain number of participants subjects
  ...
  file=paste('/export02/data/Sapphire_stability/new_results/0.2_beta_peak_participant_subset_noSubj_', n,'_no_of_iteration_',k, '_relative.csv', sep = '')
...
num_subj= 500
num_feats=751
alpha_row=40:91 #25:37 is for alpha; 40:91 for beta
num_file_iter=1000

load('/export02/data/Sapphire_stability/SimulatedData/beta_new/0.2_250_PSD/PSD_all_data.rds')
